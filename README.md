...
**Interpret trends: frequency of 'Solder clog' and 'Material Shortage' increase during period**. Confirm by <ins> **sum of downtime increase while average downtime reduce**</ins>.

![Alternative text for the image](bar graph which show +/- %change of overall downtime minute over period)

- **Strong negative correlation** was found between _**downtime minute and actual production minute**_(corr coeff = -0.85).Same correlation pattern as individaul downtime causation(less than - 0.80). Assumpation:
